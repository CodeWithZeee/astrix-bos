...
const LoadingScreen = ({ onLoadingComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-[#000000]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        ></div>
        <div
          className="absolute bottom-1/3 left-1/3 w-1 h-1 bg-greenx-400/30 rounded-full animate-ping"
