          ...
          <RevealAnimation delay={0.1}>
            <div className="text-center mb-16 animate-fade-in-up">
              ...
              <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
                Service Businesses Aren't Failing — They're Drowning in
                Operations
              </p>
            </div>
          </RevealAnimation>
      ...
      <section className="py-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <RevealAnimation delay={0.2}>
            <div className="mb-12 animate-fade-in-up animate-delay-200">
              <p className="text-lg text-slate-200 text-center max-w-4xl mx-auto leading-relaxed">
                Noha is powered by AstrixBOS, the first AI-native operating
                system built for service businesses. Together, they clear every
